...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e8e8e8] flex items-center justify-center p-4 relative overflow-hidden">

      <motion.div 
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full max-w-md bg-white border border-[#b3b3b3] p-8 shadow-lg relative z-10"
      >
        <div className="flex flex-col items-center text-center">
          <div className="w-20 h-20 bg-[#4a934a] rounded-full flex items-center justify-center mb-6 shadow border-2 border-[#3a7a3a]">
            <span className="text-3xl font-black text-white font-mono">A+F</span>
          </div>
          <h1 className="text-2xl font-black text-[#4a934a] mb-2 font-mono tracking-tight">
            A+F=C.B Messenger
          </h1>
          <p className="text-xs font-bold text-[#666] mb-8 max-w-[260px] leading-relaxed font-mono">
            ICQ tarzı mesajlaşma deneyimi.
          </p>
          ...
          <button 
            onClick={handleLogin}
            disabled={loading}
            className="w-full bg-[#4a934a] hover:bg-[#3a7a3a] disabled:bg-[#a3c4a3] text-white font-bold py-4 transition-all flex items-center justify-center gap-3 border border-[#3a7a3a]"
          >
            {loading ? (
          ...
          <div className="mt-4 flex items-center gap-4">
            <p className="text-[9px] text-[#888] uppercase tracking-[0.15em] font-bold font-mono">
              A+F/C.B v3.0
            </p>
            <button
              onClick={() => setShowAdminPassword(true)}
              className="text-[8px] text-[#4a934a] hover:text-[#3a7a3a] uppercase tracking-[0.1em] font-bold transition-colors font-mono"
            >
              Yönetim
            </button>
          </div>
